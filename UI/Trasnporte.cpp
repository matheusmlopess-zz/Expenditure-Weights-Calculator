...
using namespace std;
Transporte::Transporte(string nomePessoa, int anoO, int mesS, int valor){
bool sai =false;
std::ostringstream geraTxt,geraTxt2;
geraTxt2 <<"Despesas_"<< nomePessoa <<".txt"; 
geraTxt <<"Transporte_"<< nomePessoa <<"_"<< std::to_string(anoO) <<"_"<<std::to_string(mesS)<<".txt"; 
	...
	do{
		...
		cout << "\t| Tem mais despesas com Transporte para o mes: "<< endl;
		cout << "\t|"<< mesS <<" e ano : " << anoO <<" ?       "<< endl;
		cout << "\t|            1 - sim 2- nao             > ";
		cin>> yesNo;
