...
using namespace std;
Estudos::Estudos(string nomePessoa, int anoO, int mesS, int valor){
bool sai =false;
std::ostringstream geraTxt,geraTxt2;
geraTxt2 <<"Despesas_"<< nomePessoa <<".txt"; 
geraTxt <<"Estudos_"<< nomePessoa <<"_"<< std::to_string(anoO) <<"_"<<std::to_string(mesS)<<".txt"; 
	...
	do{
		...
		cout << "\t|    Tem mais despesas com ESTUDO para:     |"<< endl;
